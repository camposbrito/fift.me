...
<link rel="stylesheet" type="text/css" href="http://camposbrito.com.br/projetobley/report/_css/style.css" />
<!--</head>-->
<?php
...
<!--<body>-->
	<div class="paper">
		...
		<div class="table">
			...
			<div class="sublinhado w580"> <?=utf8_encode($consulta[0]->PacienteNome); ?></div>
			<div class="descricao">Data:</div>
			<div class="sublinhado w100"> <?=dataBR($consulta[0]->Data); ?></div>
			<div class="sublinhado w5"> </div>
			
			<div class="clear"></div>
			
			<div class="descricao">RG:</div>
			<div class="sublinhado w200">  <?=$paciente[0]->RG  ?> </div>
			<div class="descricao">Data de Nascimento:</div>
			<div class="sublinhado w200">  <?=dataBR($paciente[0]->DataNascimento ) ?> </div>
			<div class="descricao">Idade:</div>
			<div class="sublinhado w150">  <?=utf8_encode(calculaIdade($consulta[0]->Data , $paciente[0]->DataNascimento) )?></div>
			<div class="sublinhado w5"> </div>
			<div class="sublinhado w1"> </div> 
			<div class="clear"></div>
			
			<div class="descricao">Nacionalidade: </div>
			<div class="sublinhado  w250"> <?=$paciente[0]->Nacionalidade ?> </div>
