    ...
    <form class="form-horizontal" action="<?= $action ?>" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input id="Descricao" name="Descricao" type="text" placeholder="Informe a Descrição" class="form-control input-sm  autofocus" required="">
                </div>
            </div>
            <!-- Text input-->
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <textarea rows="5" id="Obs" name="Obs" type="text" placeholder="Informe uma observação" class="form-control input-sm  autofocus"  required=""></textarea>
                </div>
            </div>
