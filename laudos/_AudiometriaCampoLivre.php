...
<body>
	<div class="paper">
		<div class="table">
			...
			<div class="sublinhado w140">  <?=isset($rsE)?dataBR(@$rsE[0]['Calibracao']):"";?></div>
			<div class="sublinhado w5"> </div>
			<div class="sublinhado w5"> </div>
			<div class="sublinhado w5"> </div>
			<div class="sublinhado w1"> </div>
			...
			<table class="tabela w600 centro pequeno">
			<tr><td colspan="9" style="border:0">AUDIOMETRIA COM A.A.S.I. </td></tr>
			<tr>	
				<td class="Freq"></td>
				<td class="Freq">0,25k Hz </td>
				<td class="Freq">0,5k Hz </td>
			...
			<tr>
				...
				<td class="f10"><?=@$rsoeod[0]['Freq025'];?></td>
				<td class="f10"><?=@$rsoeod[0]['Freq05'];?></td>
				<td class="f10"><?=@$rsoeod[0]['Freq1'];?></td>
				<td class="f10"><?=@$rsoeod[0]['Freq2'];?></td>
				<td class="f10"><?=@$rsoeod[0]['Freq4'];?></td>
				<td class="f10"><?=@$rsoeod[0]['LDF'];?></td>
				<td class="f10"><?=@$rsoeod[0]['LRF'];?></td>
				<td class="f10"><?=@$rsoeod[0]['IPRF'];?></td>
			</tr>			
			<?php 
			...
			<tr style="font-weight: 900;">
				<td>OD <sub>dB</sub></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['Freq025']);?></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['Freq05']);?></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['Freq1']);?></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['Freq2']);?></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['Freq4']);?></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['LDF']);?></td>
				<td class="f10"><?=ImprimeColor('D',@$rsod[0]['LRF']);?></td>
			...
			<tr style="font-weight: 900;">
				<td>OE <sub>dB</sub></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['Freq025']);?></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['Freq05']);?></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['Freq1']);?></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['Freq2']);?></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['Freq4']);?></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['LDF']);?></td>
				<td class="f10"><?=ImprimeColor('E',@$rsoe[0]['LRF']);?></td>
			...
			<div class="Parecer">
					...
					?>
				<table>
					<tr class="memo"><td class="w55">Prótese:</td><td class="w25">OD:</td><td style="font-weight: 900;" class="sublinhado"><?=ImprimeColor('D',utf8_encode(nl2br(@$rsParecer[0]['ProteseOD'])))?></td></tr>
					<tr class="memo"><td></td><td>OE:</td><td style="font-weight: 900;" class="sublinhado"><?=ImprimeColor('E',utf8_encode(nl2br(@$rsParecer[0]['ProteseOE'])))?></td></tr>
				</table>
				<table>				
					<tr>
						<td class="memo2 h100">Parecer: <?=utf8_encode(nl2br(@$rsParecer[0]['ObservacaoCampolivre'])); ?></td>
					</tr>
				</table>			
			</div>
			<div class="Parecer">
				...
				<table>				
					<tr>
						<td class="memo2 memo2S h100">Parecer Prótese: <?=utf8_encode(nl2br(@$rsParecer[0]['ObsProtese']) ); ?></td>
					</tr>
				</table>			
			</div>
			<div class="clear"></div>
