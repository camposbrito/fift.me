...
<html>
    <head>
        <title>Avaliação Audiométrica Ocupacional [NEW]</title>
    ...
    if (isset($_GET['Consulta'])) {
        ...
        <body>
            <div class="paper">
                <div class="table">
                    <div class="Logo"><img alt="Clinica Copec" width="250px" src="./_img/CPAA.jpg" /></div>
                    ...
                    <div class="sublinhado w126">  <?= calculaIdade(@$rsC[0]['Data'], @$rsP[0]['DataNascimento']); ?></div>
                    <div class="sublinhado w5"> </div>
                    <div class="sublinhado w1"> </div> 
                    <div class="clear"></div>
                    <div class="descricao">Data Calibração:</div>
                    <div class="sublinhado w100"><?= isset($rsEC) ? dataBR(@$rsEC[0]['Calibracao']) : ""; ?></div>
                    ...
                    <div class="clear h9"></div>
                    <div class="TipoExame" style="padding-top: 010px;">
                        <?php
                    ...
                    <table>
                        ...
                        <tr>	
                            <td colspan='1' class='h50 memo2f memo2 esquerda' style="font-size: 13.3333px">
                    <?= utf8_encode(nl2br(strtoupper('<div class="bold" style="float:left"> Dados Relevantes da Anamnese: </div>').'&nbsp;&nbsp;   '.@$rsParecer[0]['DadosAnamnese'])); ?>
                            </td>
                        </tr>
                    </table>
                    <?php
    ...
    <?php echo " <img class='centro' src='./OD_v1.php?Consulta=" . @$_GET['Consulta'] . "'/>"; ?>
                    ...
                    <div class="clear"></div>
                    <div class="Parecer">
                        <div class="titulo bold"  style="font-size: 13.3333px;">parecer audiológico</div>
                        <table>				
                            <tr>	
                                <td colspan='2' class='centro h106' style="font-size: 13.3333px  ;  vertical-align: top;">
