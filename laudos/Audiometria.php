...
<body>
	<div class="paper">
		<div class="table">
			...
			<div class="sublinhado w150">  <?= isset($rsEC) ? dataBR(@$rsEC[0]['Calibracao']) : ""; ?></div>
			<div class="sublinhado w5"> </div>
			<div class="sublinhado w1"> </div>
			<div class="clear"></div>
			...
			<div class="DuasCol">
				...
				<div class="col5 W310">
					...
					?>
					<table class="tabela w300" border="1" cellpadding="5" cellspacing="0" style="width:331px;height: 136px;;">
			...
			<div class="Parecer h120">
					...
					<tr class="memo2 centro"><td >  <?=isset($rsParecer[0])?utf8_encode(nl2br(@$rsParecer[0]['Descricao'])):""; ?></td>
					</tr>
				</table>			
			</div>
			<div class="clear"></div>
