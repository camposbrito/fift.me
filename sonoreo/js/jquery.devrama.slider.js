...
// (function($){
// 	var DrSlider1 = function(element, options){
...
// 	$.fn.DrSlider1 = function (options) {
		
// 		if (typeof options === 'string') {
			
// 			var data = $this.data('DrSlider');
// 			if (!data) $this.data('DrSlider', (data = new DrSlider1(this, options)));
...
// 	$.fn.DrSlider1.Constructor = DrSlider1;
...
// (function($){
// 	var DrSlider2 = function(element, options){
// 		this.width = undefined,
// 		this.height = undefined,
// 		this.parent_width = undefined,
// 		this.num_slides = 0;
...
// 					if(typeof that.options.onReady == 'function') that.options.onReady(); 
// 					that._playSlide();
// 					$(window).on('resize.DrSlider2', function(){
// 						that._resize();
// 					});
// 				});
// 			});
...
// 			var that = this;
// 			var navigation_html = '';
// 			var dots = ["Residencial", "Igrejas", "Empresa", "Lojas", "Escolas"];
// 			for(var i =0; i < this.num_slides; i++)
// 				navigation_html += '<span class="nav-link index'+i+'" data-num="'+i+'"><a href="#">'+dots[i]+'</a></span>';
...
// 	$.fn.DrSlider2 = function (options) {
		
// 		if (typeof options === 'string') {
			
// 			var data = $this.data('DrSlider');
// 			if (!data) $this.data('DrSlider', (data = new DrSlider2(this, options)));
...
// 	$.fn.DrSlider2.Constructor = DrSlider2;
...
// (function($){
// 	var DrSlider3 = function(element, options){
// 		this.width = undefined,
// 		this.height = undefined,
// 		this.parent_width = undefined,
// 		this.num_slides = 0;
...
// 					if(typeof that.options.onReady == 'function') that.options.onReady(); 
// 					that._playSlide();
// 					$(window).on('resize.DrSlider3', function(){
// 						that._resize();
// 					});
// 				});
// 			});
...
// 	$.fn.DrSlider3 = function (options) {
		
// 		if (typeof options === 'string') {
			
// 			var data = $this.data('DrSlider');
// 			if (!data) $this.data('DrSlider', (data = new DrSlider3(this, options)));
...
// 	$.fn.DrSlider3.Constructor = DrSlider3;
...
(function($){
	...
	DrSlider.prototype = {
		...
		_attachNavigation: function(){
			...
			var that = this;
			var navigation_html = '';
			var tooltip = ["Residencial", "Igrejas", "Empresas", "Lojas", "Escolas"];
			for(var i =0; i < this.num_slides; i++)
				navigation_html += '<span  class="awesome-tooltip nav-link index'+i+'" data-num="'+i+'">'+(i+1)+'<a  "href="#">'+tooltip[i]+'</a></span>';
					
			this.$ele_projector.after('<div id="nav-dots"  class="nav-dots dotstyle-tooltip navigation devrama-slider" ><div class="inner">'+navigation_html+'</div></div>');
